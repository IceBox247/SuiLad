export type Chain = 'sui' | 'ethereum' | 'solana' | 'base' | 'arbitrum' | 'polygon' | 'bsc' | 'arc' | 'stable' | 'robinhood';

export const SUPPORTED_CHAINS: Chain[] = ['sui', 'ethereum', 'solana', 'base', 'arbitrum', 'polygon', 'bsc', 'arc', 'stable', 'robinhood'];
